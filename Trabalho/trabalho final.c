...
int AnalisaMorte(tJogador jogador, tFantasma f, int lant, int cant){
...
tJogo JogaJogo(tJogo jogo, FILE * resumo){
    ...
    for(i=1; i<=jogo.jogadas; i++){
        ...
        resp = AnalisaMorte(jogo.jogador, jogo.B, x, y);
        if(resp == 1 || resp == 2){
            caso = 1;
        }
        ...
        resp = AnalisaMorte(jogo.jogador, jogo.C, x, y);
        if(resp == 1 || resp == 2){
            caso = 1;
        }
        if(resp == 2){
        ...
        resp = AnalisaMorte(jogo.jogador, jogo.P, x, y);
        if(resp == 1 || resp == 2){
            caso = 1;
        }
        if(resp == 2){
        ...
        resp = AnalisaMorte(jogo.jogador, jogo.I, x, y);
        if(resp == 1 || resp == 2){
            caso = 1;
        }
        if(resp == 2){
